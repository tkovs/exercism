...
describe("Protein Translation", () => {
  open Expect;
  describe("rnasStringToList", () => {
    test("handle empty string", () => {
      expect(ProteinTranslation.rnasStringToList("")) |> toEqual([])
    })
    test("map proteins to list", () => {
      expect(ProteinTranslation.rnasStringToList("AUGUUU")) |> toEqual(["AUG", "UUU"])
    })
  })
  describe("proteins", () => {
